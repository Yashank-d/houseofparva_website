...
export const artisticWorks: ArtisticWork[] = [
  ...
  },
  {
    id: "blue-ink-love",
    figNum: "FIG. 03",
    couple: "Ananya and Rahul",
    location: "Bangalore, Karnataka",
    date: "March 15, 2026",
    styleType: "blue-ink-polaroid",
    mainImage: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=1200&q=85",
    blueQuote: `"i love you, today, tommorow and forever." <3`,
    handwrittenStory: "A quiet portrait taken in the ancestral courtyard before the evening rituals.",
    details: "Taped B&W silver gelatin polaroid with hand-lettered ink.",
    gallery: [
