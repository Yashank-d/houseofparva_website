    ...
    <div className="w-full h-full p-6 md:p-12 flex flex-col justify-between relative overflow-hidden select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto">
        ...
        <div className="lg:col-span-6 space-y-5">
          ...
          <div className="relative bg-[#2B0F14] text-[#F5F1E8] p-6 md:p-7 rounded-xs shadow-[0_14px_36px_rgba(0,0,0,0.22)] border border-[#C9A86A]/15 max-w-lg overflow-hidden">
