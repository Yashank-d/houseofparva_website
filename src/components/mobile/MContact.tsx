  ...
  return (
    <div className="w-full pt-4 pb-[110px]">
      ...
      <Reveal className="mx-4 rounded-[28px] bg-[#2B0F14]/90 backdrop-blur-md p-6 shadow-[0_18px_44px_rgba(43,15,20,0.35)] border border-[#C9A86A]/15" y={20}>
        ...
        <h2 className="font-serif-editorial text-[32px] leading-[0.95] uppercase text-[#F5F1E8] mt-2">
          We&apos;d love to
          <br />
        ...
        {!sent ? (
          <form onSubmit={submit}>
            ...
            <div>
              ...
              <textarea required rows={3} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} placeholder="Tell us about your dates, venue, story…" className={`${fieldCls} resize-none`} />
            </div>
            {err && <p className="font-sans-utility text-[14px] text-[#641F27] mt-4">{err}</p>}
            <button
              type="submit"
              disabled={loading}
              className="w-full h-[54px] mt-6 rounded-full bg-[#2B0F14] text-[#F5F1E8] font-sans-utility text-[12px] tracking-[0.2em] uppercase font-bold disabled:opacity-60 active:opacity-85 active:scale-[0.98] transition"
            >
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-8 text-center">
            ...
            <p className="font-script text-[21px] text-[#641F27] mt-1">Can&apos;t wait to create magic together.</p>
          </motion.div>
        )}
      </Reveal>
      ...
      <Reveal className="mx-4 mt-4 rounded-[28px] bg-[#2B0F14]/85 backdrop-blur-md p-5 shadow-[0_18px_44px_rgba(43,15,20,0.3)] border border-[#C9A86A]/15" y={22}>
        ...
        <div className="mt-3 space-y-2">
          <a href="mailto:hello@thehouseofparva.in" className="min-h-[56px] rounded-[18px] bg-white/[0.06] border border-[#C9A86A]/20 px-4 flex items-center gap-3">
            ...
            <span className="font-sans-utility text-[14px] text-[#F5F1E8]">hello@thehouseofparva.in</span>
          </a>
          <a href="https://instagram.com/weddingsbyparva" target="_blank" rel="noopener noreferrer" className="min-h-[56px] rounded-[18px] bg-white/[0.06] border border-[#C9A86A]/20 px-4 flex items-center gap-3">
            ...
            <span className="font-sans-utility text-[14px] text-[#F5F1E8]">@weddingsbyparva</span>
          </a>
          <div className="min-h-[56px] rounded-[18px] px-4 flex items-center">
            <span className="font-sans-utility text-[12px] tracking-[0.14em] uppercase text-[#F5F1E8]/55">Bangalore, India & worldwide</span>
          </div>
        </div>
      </Reveal>
    </div>
