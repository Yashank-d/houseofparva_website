      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-3.5 bg-[#2B0F14] text-[#F5F1E8] hover:bg-[#641F27] disabled:opacity-60 disabled:cursor-not-allowed font-sans-utility text-xs tracking-[0.25em] uppercase transition-all duration-500 rounded-xs shadow-md flex items-center gap-3 group"
              >
        ...
        <div className="lg:col-span-6 relative hidden lg:block">
          <div className="relative w-full max-w-md mx-auto">
            ...
            />
            <div className="absolute -bottom-20 -right-12 z-30 bg-[#2B0F14] text-[#F5F1E8] p-5 rounded-xs shadow-[0_16px_36px_rgba(0,0,0,0.28)] rotate-[-5.5deg] border border-[#C9A86A]/15 min-w-[270px]">
