...
import { weddingsServices } from "@/data/services";
    ...
    <div className="w-full h-full p-6 md:p-12 flex flex-col justify-between relative overflow-hidden select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <EnquiryForm
            accent="#641F27"
            services={weddingsServices.map((s) => s.name)}
            messagePlaceholder="Tell us about your wedding dates, venue, or story..."
            successScript="Can't wait to create magic together."
          />
        </div>
